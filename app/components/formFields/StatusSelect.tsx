    ...
    <div className="grid gap-1.5">
      ...
      <div className="relative" ref={containerRef}>
        ...
        {open ? (
          <div
            aria-labelledby={id}
            className="absolute inset-x-0 top-[calc(100%+4px)] z-20 max-h-56 overflow-y-auto rounded-[var(--radius-control)] border border-border bg-surface shadow-[var(--shadow-card)]"
            id={`${id}-options`}
            role="listbox"
          >
            {options.map((option) => {
